...
export const ResponsiveAppBar: FunctionComponent<AuthenticationResponsePropsInterface> = (
    ...
    return (
        <AppBar style={{ backgroundImage: "linear-gradient(to right, #00395d, #8f8f8c)" }}>
